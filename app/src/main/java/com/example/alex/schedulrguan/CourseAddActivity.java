...
public class CourseAddActivity extends AppCompatActivity {
    ...
    public void updateInfo(View V)
    {
        ...
        {
            AlertDialog alertDialog = new AlertDialog.Builder(CourseAddActivity.this).create();
    ...
    {
        Intent intentSchedActivity = new Intent(CourseAddActivity.this, CourseActivity.class);
        startActivity(intentSchedActivity);
    }

    private void switchToSched()
    {
        Intent intentSchedActivity = new Intent(CourseAddActivity.this, ScheduleActivity.class);
        startActivity(intentSchedActivity);
    }

    private void switchToSettings()
    {
        Intent intentSchedActivity = new Intent(CourseAddActivity.this, SettingsActivity.class);
        startActivity(intentSchedActivity);
    }
}
