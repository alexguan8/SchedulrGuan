...
public class CourseFiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_five);
    ...
    {
        EditText courseNameEditText = (EditText)findViewById(R.id.classFiveEdit);
        EditText courseGradeEditText = (EditText)findViewById(R.id.gradeEditFive);
        SeekBar diffBar = (SeekBar)findViewById(R.id.difficultySliderFive);
        ...
        if(!courseName.equals("") && !courseGradeValue.equals("")) {
            ...
            CalendarView dateTestCalendarView = (CalendarView)findViewById(R.id.testDateCalendarFive);
        ...
        {
            AlertDialog alertDialog = new AlertDialog.Builder(CourseFiveActivity.this).create();
    ...
    {
        Intent intentSchedActivity = new Intent(CourseFiveActivity.this, CourseActivity.class);
        startActivity(intentSchedActivity);
    }

    private void switchToSched()
    {
        Intent intentSchedActivity = new Intent(CourseFiveActivity.this, ScheduleActivity.class);
        startActivity(intentSchedActivity);
    }

    private void switchToSettings()
    {
        Intent intentSchedActivity = new Intent(CourseFiveActivity.this, SettingsActivity.class);
        startActivity(intentSchedActivity);
    }
}
