...
public class CourseFourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_four);
    ...
    {
        EditText courseNameEditText = (EditText)findViewById(R.id.classFourEdit);
        EditText courseGradeEditText = (EditText)findViewById(R.id.gradeEditFour);
        SeekBar diffBar = (SeekBar)findViewById(R.id.difficultySliderFour);
        ...
        if(!courseName.equals("") && !courseGradeValue.equals("")) {
            ...
            CalendarView dateTestCalendarView = (CalendarView)findViewById(R.id.testDateCalendarFour);
        ...
        {
            AlertDialog alertDialog = new AlertDialog.Builder(CourseFourActivity.this).create();
    ...
    {
        Intent intentSchedActivity = new Intent(CourseFourActivity.this, CourseActivity.class);
        startActivity(intentSchedActivity);
    }

    private void switchToSched()
    {
        Intent intentSchedActivity = new Intent(CourseFourActivity.this, ScheduleActivity.class);
        startActivity(intentSchedActivity);
    }

    private void switchToSettings()
    {
        Intent intentSchedActivity = new Intent(CourseFourActivity.this, SettingsActivity.class);
        startActivity(intentSchedActivity);
    }
}
