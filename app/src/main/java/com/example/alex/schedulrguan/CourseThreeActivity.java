...
public class CourseThreeActivity extends AppCompatActivity {
    ...
    {
        EditText courseNameEditText = (EditText)findViewById(R.id.classThreeEdit);
        EditText courseGradeEditText = (EditText)findViewById(R.id.gradeEditThree);
        SeekBar diffBar = (SeekBar)findViewById(R.id.difficultySliderThree);
        ...
        if(!courseName.equals("") && !courseGradeValue.equals("")) {
            ...
            CalendarView dateTestCalendarView = (CalendarView)findViewById(R.id.testDateCalendarThree);
        ...
        {
            AlertDialog alertDialog = new AlertDialog.Builder(CourseThreeActivity.this).create();
    ...
    {
        Intent intentSchedActivity = new Intent(CourseThreeActivity.this, CourseActivity.class);
        startActivity(intentSchedActivity);
    }

    private void switchToSched()
    {
        Intent intentSchedActivity = new Intent(CourseThreeActivity.this, ScheduleActivity.class);
        startActivity(intentSchedActivity);
    }

    private void switchToSettings()
    {
        Intent intentSchedActivity = new Intent(CourseThreeActivity.this, SettingsActivity.class);
        startActivity(intentSchedActivity);
    }
}
